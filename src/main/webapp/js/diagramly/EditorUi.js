...
(function()
{
	...
	mxUtils.get(NOTIFICATIONS_URL, function(req)
	{
		console.log(req,'req')
	}, function(res) {
		console.log(res)
	...
	ajax.open('get',NOTIFICATIONS_URL);
	//步骤三:发送请求
	ajax.send();
...
//		}
	...
	EditorUi.prototype.setDatabaseItem = function(key, data, success, error, storeName)
	{
		this.openDatabase(mxUtils.bind(this, function(db)
		{
			try
			{
				...
				console.log(storeName,key,data,'好多东西')
				...
				$.ajax({
					type: "POST",
					url: "http://localhost/dev-api/table/draw/insertDraw",
					headers: {
						Accept: "application/json; charset=utf-8",
						Authorization: "Bearer eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6ImQ1OWQyZTVlLTg1OGItNGFkMS1iMDJkLTAwNWJlMjYwNmRiMSJ9.dwY6ozLdkYxKlMfGHqXfHDpc1PviO--oWOUD16Jk9S_Jajja8PHyAafcxUrrmf3IUIeWfKNEgdzIvDCkvXE46A",
					},
					...
					success: function(data){
						...
						if(data.code === 500){
							$.ajax({
								type: "POST",
								url: "http://localhost/dev-api/table/draw/updateDraw",
								headers: {
									Accept: "application/json; charset=utf-8",
									Authorization: "Bearer eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6ImQ1OWQyZTVlLTg1OGItNGFkMS1iMDJkLTAwNWJlMjYwNmRiMSJ9.dwY6ozLdkYxKlMfGHqXfHDpc1PviO--oWOUD16Jk9S_Jajja8PHyAafcxUrrmf3IUIeWfKNEgdzIvDCkvXE46A",
								},
	...
	EditorUi.prototype.getDatabaseItem = function(key, success, error, storeName)
	{
		this.openDatabase(mxUtils.bind(this, function(db)
		{
			try
			{
				...
				{
					console.log(req.result,'reqshdks')
					var selectparams = {
						tableName:"QRTZ_FILES",
						key:req.result ?  req.result.title : '',
						data:''
					}
					$.ajax({
						type: "POST",
						url: "http://localhost/dev-api/table/draw/selectDrawList",
						beforeSend: function(xhr) {
							xhr.setRequestHeader("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6ImQ1OWQyZTVlLTg1OGItNGFkMS1iMDJkLTAwNWJlMjYwNmRiMSJ9.dwY6ozLdkYxKlMfGHqXfHDpc1PviO--oWOUD16Jk9S_Jajja8PHyAafcxUrrmf3IUIeWfKNEgdzIvDCkvXE46A");
						},
						headers: {
							Accept: "application/json; charset=utf-8"
						},
						...
						success: function(data){
							...
							if(current && current.data && current.data.length !== 0){
								current.data[0].title = current.data[0].key
	...
	{
		// mxUtils.bind返回将给定函数的执行范围锁定到指定范围的包装函数。在功能内部，“this”关键字将成为对该范围的引用
		this.openDatabase(mxUtils.bind(this, function(db)
		{
			console.log(db,'db')
			try
	...
	EditorUi.prototype.getDatabaseItemKeys = function(success, error, storeName)
	{
		this.openDatabase(mxUtils.bind(this, function(db)
		{
			try
			{
				...
				req.onsuccess = function()
				{
					console.log(req.result,'reqshdks--key')
					success(req.result);
		        };
