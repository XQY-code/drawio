(function()
{
	...
	Sidebar.prototype.addWebIconsPalette = function()
	{
		...
		[
		 ...
		 this.createVertexTemplateEntry(s + 'axios;gradientColor=#DFDEDE',
				 w * 512, h * 512, '', 'Axios', null, null, this.getTagsForStencil(gn, 'axios', dt).join(' ')),
	...
	Sidebar.prototype.addWebLogosPalette = function()
	{
		...
		[
		 ...
		 this.createVertexTemplateEntry(s + 'jquery;fillColor=#0BB9EA;gradientColor=#032F80',
				 ...
				 this.createVertexTemplateEntry(s + 'axios',
				 w * 369, h * 335, '', 'Axios', null, null, this.getTagsForStencil(gn, 'axios', dt).join(' ')),
